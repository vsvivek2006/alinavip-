          ...
          <div className="prose-luxury bg-[#faf6f2] p-8 md:p-12 rounded-2xl border border-gold-200/60 shadow-sm">
            ...
            <div className="space-y-4 text-gray-700 text-lg leading-relaxed">
              ...
              <div className="mt-8 pt-6 border-t border-gold-200/60 space-y-4">
                ...
                <p className="text-sm text-gray-700 leading-relaxed">
                  The escort industry in Gurgaon unfortunately has unregulated actors who demand advance booking deposits or gift cards and then fail to deliver. At ALINA VIP, we maintain an ethical, transparent booking process. We support direct Cash on Delivery (COD), allowing you to verify your escort upon arrival before settling the booking fee. No hidden surcharges, no misleading photos, and no advance payment traps.
                </p>
              </div>
